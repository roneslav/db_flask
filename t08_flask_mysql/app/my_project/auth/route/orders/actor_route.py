...
@actor_bp.post('/date/<string:date_of_birth>/name/<string:actor_name>')
def insert_actors_data(date_of_birth, actor_name) -> Response:
    actor_controller.insert_actors(actor_name, date_of_birth)
    return make_response("Actor inserted successfully", HTTPStatus.CREATED)


@actor_bp.post('/actor/<string:actor_name>/movie/<string:movie_name>')
def insert_actors_and_movie_dependency(actor_name, movie_name) -> Response:
    actor_controller.insert_actors_and_movie_dependency(actor_name, movie_name)
    return make_response("Actor and movie names inserted successfully", HTTPStatus.CREATED)
